...
class LibMemcached {
    ...
    public function setMockInstance()
    {
        $this->instance = (new \MyOperator\MemcachedMock);
    ...
    public static function getMockInstance() {
        ...
        {
            self::$class_instance = (new LibMemcached())->setMockInstance();
        }
    ...
    public static function getInstance($args=array())
    {
        if(!(self::$class_instance instanceof LibMemcached))
        {
            self::$class_instance = (new LibMemcached($args))->setInstance();
        }
        return self::$class_instance;
    }
